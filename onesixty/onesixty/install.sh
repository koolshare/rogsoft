...
install_now(){
	# default value
	local TITLE="RT-AX86U 160MHz"
	local DESCR="让AX86U实现160MHz频宽"
	...
	# Permissions
	chmod 755 /koolshare/bin/onesixty >/dev/null 2>&1
	chmod 755 /koolshare/scripts/onesixty_config >/dev/null 2>&1
