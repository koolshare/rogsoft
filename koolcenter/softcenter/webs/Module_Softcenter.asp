...
<head>
	...
	<!--  -->
	<script type="module" crossorigin src="/res/soft-v19/assets/index-Bgv_0qwd.js"></script>
	<link rel="stylesheet" crossorigin href="/res/soft-v19/assets/style-CaDURS9T.css">
	<!--  -->
</head>
