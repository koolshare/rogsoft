...
function get_status() {
	...
	var postData = {"id": id, "method": "nodejs_status.sh", "params": [1], "fields": {} };
	$.ajax({
		type: "POST",
		cache: false,
		url: "/_api/",
...
function menu_hook() {
	tabtitle[tabtitle.length - 1] = new Array("", "nodejs");
	tablink[tablink.length - 1] = new Array("", "Module_nodejs.asp");
}
...
<input type="hidden" name="current_page" value="Module_nodejs.asp"/>
<input type="hidden" name="next_page" value="Module_nodejs.asp"/>
							...
							<table width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3" class="FormTitle" id="FormTitle">
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top">
										<div>&nbsp;</div>
										<div style="float:left;" class="formfonttitle" style="padding-top: 12px">Node.js<lable id="nodejs_version"></lable></div>
										<div style="float:right; width:15px; height:25px;margin-top:10px"><img id="return_btn" onclick="reload_Soft_Center();" align="right" style="cursor:pointer;position:absolute;margin-left:-30px;margin-top:-25px;" title="返回软件中心" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'"></img></div>
										<div style="margin:30px 0 10px 5px;" class="splitLine"></div>
										<div style="margin-left:5px;" id="head_illustrate">
											<li>Node.js插件可以轻松帮你安装Node.js环境。</li>
										</div>
											...
											<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
												...
												<td>
													<ul>
														...
														&nbsp;&nbsp;&nbsp;&nbsp;2. 本插件仅从Entware环境中安装Node.js环境，其它配置如更换node国内源等请自行使用命令操作。<br />
														&nbsp;&nbsp;&nbsp;&nbsp;3. 签到狗3.0等插件依赖Node.js，卸载本插件后可能导致签到狗3.0部分功能出现问题。<br />
													</ul>
												</td>
												</tr>
											</table>
