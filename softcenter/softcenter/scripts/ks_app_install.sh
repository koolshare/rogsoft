...
########################################################################
#
# Copyright (C) 2011/2025 kooldev
#
# 此脚本为 hnd/axhnd/axhnd.675x/p1axhnd.675x/504axhnd.675x/mtk/ipq32/ipq64平台软件中心插件在线安装脚本。
#
########################################################################
#
...
install_ks_module() {
	...
	if [ "${RO_MODEL}" == "TX-AX6000" -o "${RO_MODEL}" == "TUF-AX4200Q" -o "${RO_MODEL}" == "RT-AX57_Go" -o "${RO_MODEL}" == "GS7" -o "${RO_MODEL}" == "ZenWiFi_BT8P" -o "${RO_MODEL}" == "GS7_Air" ];then
